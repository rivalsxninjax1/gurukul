# ui/styles.py — single source of truth, full visibility fixes
...
# ── Dropdowns — visible arrow, visible text ───────────────────────────────────
COMBO_STYLE = """
    QComboBox {
        border: 1.5px solid #cccccc;
        border-radius: 5px;
...
TABLE_STYLE = """
    ...
    QScrollBar:vertical {
        border: none; background: #f5f5f5; width: 8px;
    }
    QScrollBar::handle:vertical {
        background: #cccccc; border-radius: 4px; min-height: 20px;
    }
    QScrollBar:horizontal {
        border: none; background: #f5f5f5; height: 8px;
    }
...
# ── Message box colors (used inline in QLabel) ────────────────────────────────
MSG_SUCCESS_FG  = "#1a5c1a"
MSG_SUCCESS_BG  = "#e6f4e6"
MSG_SUCCESS_BD  = "#b8ddb8"
MSG_ERROR_FG    = "#8b0000"
MSG_ERROR_BG    = "#fdeaea"
MSG_ERROR_BD    = "#f5b8b8"
MSG_WARNING_FG  = "#7a4f00"
MSG_WARNING_BG  = "#fdf3e0"
MSG_WARNING_BD  = "#f5d98b"
MSG_INFO_FG     = "#1a3a6b"
MSG_INFO_BG     = "#e8f0fb"
MSG_INFO_BD     = "#b8cef5"